/**
 * Insightify — FeedHeader (Component)
 *
 * Top application header on the Threat Feed screen:
 * Left: Official Insightify shield logo + "Insightify"
...
export default function FeedHeader({
  ...
  const logoSize = moderateScale(40, 0.4);
